      ...
      <div className="footer-content">
        <div className="footer-top">
          <div className="footer-logo-section">
            <img src={WebutationLogo} alt="Webutation Logo" className="footer-logo" />
            <p className="footer-tagline">
              Protecting businesses through comprehensive social intelligence
            </p>
            <div className="footer-social">
              <a href="#" className="social-icon"><SiFacebook /></a>
              <a href="#" className="social-icon"><SiX /></a>
              <a href="#" className="social-icon"><SiInstagram /></a>
              <a href="#" className="social-icon"><SiLinkedin /></a>
              <a href="#" className="social-icon"><SiTiktok /></a>
            </div>
          </div>
          ...
          <div className="footer-links-container">
            ...
            <div className="footer-links">
              ...
              <ul>
                ...
                <li><a href="#">Digital Investigation</a></li>
              </ul>
            </div>
              ...
              <ul>
                <li>
                  <a href="tel:+14848025609">
                    <svg className="contact-icon-svg" viewBox="0 0 512 512" width="14" height="14">
                ...
                <li>
                  <a href="https://goo.gl/maps/rYxcjrGggjFnKZJx9">
                    <svg className="contact-icon-svg" viewBox="0 0 384 512" width="14" height="14">
